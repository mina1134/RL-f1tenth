...
class RRT(Node):
    def __init__(self):
        ...
        self.declare_parameter('waypoints_path', '//home/mina/sim_ws/src/planner/maps/e7_floor5.csv')
...
class PurePursuit:
    def __init__(self, L=1.7, segments=1024, filepath="/sim_ws/src/f1tenth_gym_ros/planner/maps/e7_floor5.csv", K_p = 0.5):
